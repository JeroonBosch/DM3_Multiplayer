...
{
    public class SendCoinsCanvas : BaseMenuCanvas, IEntryList
    {
        [SerializeField] Button SendCoinsButton;
        ...
        public void Selected(UIEntry entry, bool yes)
        {
            ...
            Debug.Log(selectedFriendEntries.Count > 0);
            SendCoinsButton.interactable = selectedFriendEntries.Count > 0 ? true : false;
        ...
        public override void Hide()
        {
            ...
            ClearFriendList();
            SendCoinsButton.interactable = false;
            selectAllDeactiveButton.SetActive(true);
            selectAllActiveButton.SetActive(false);
        }
